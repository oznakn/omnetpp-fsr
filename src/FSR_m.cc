...
Register_Enum(inet::FSRControlPacketType, (inet::FSRControlPacketType::HELLO));
...
Register_Class(FSRHelloControlPacket)

FSRHelloControlPacket::FSRHelloControlPacket() : ::inet::FSRControlPacket()
{
}

FSRHelloControlPacket::FSRHelloControlPacket(const FSRHelloControlPacket& other) : ::inet::FSRControlPacket(other)
{
    copy(other);
}

FSRHelloControlPacket::~FSRHelloControlPacket()
{
}

FSRHelloControlPacket& FSRHelloControlPacket::operator=(const FSRHelloControlPacket& other)
{
    if (this == &other) return *this;
...
void FSRHelloControlPacket::copy(const FSRHelloControlPacket& other)
{
}

void FSRHelloControlPacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::inet::FSRControlPacket::parsimPack(b);
}

void FSRHelloControlPacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::FSRControlPacket::parsimUnpack(b);
}

class FSRHelloControlPacketDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertyNames;
    enum FieldConstants {
  ...
  public:
    FSRHelloControlPacketDescriptor();
    virtual ~FSRHelloControlPacketDescriptor();
...
Register_ClassDescriptor(FSRHelloControlPacketDescriptor)

FSRHelloControlPacketDescriptor::FSRHelloControlPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::FSRHelloControlPacket)), "inet::FSRControlPacket")
{
    propertyNames = nullptr;
}

FSRHelloControlPacketDescriptor::~FSRHelloControlPacketDescriptor()
{
    delete[] propertyNames;
}

bool FSRHelloControlPacketDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<FSRHelloControlPacket *>(obj)!=nullptr;
}

const char **FSRHelloControlPacketDescriptor::getPropertyNames() const
{
    if (!propertyNames) {
        static const char *names[] = {  nullptr };
        omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
...
const char *FSRHelloControlPacketDescriptor::getProperty(const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? base->getProperty(propertyName) : nullptr;
}

int FSRHelloControlPacketDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? 0+base->getFieldCount() : 0;
}

unsigned int FSRHelloControlPacketDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *FSRHelloControlPacketDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int FSRHelloControlPacketDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? base->findField(fieldName) : -1;
}

const char *FSRHelloControlPacketDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char **FSRHelloControlPacketDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *FSRHelloControlPacketDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int FSRHelloControlPacketDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    FSRHelloControlPacket *pp = omnetpp::fromAnyPtr<FSRHelloControlPacket>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void FSRHelloControlPacketDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    FSRHelloControlPacket *pp = omnetpp::fromAnyPtr<FSRHelloControlPacket>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'FSRHelloControlPacket'", field);
    }
}

const char *FSRHelloControlPacketDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string FSRHelloControlPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void FSRHelloControlPacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    FSRHelloControlPacket *pp = omnetpp::fromAnyPtr<FSRHelloControlPacket>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'FSRHelloControlPacket'", field);
    }
}

omnetpp::cValue FSRHelloControlPacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    FSRHelloControlPacket *pp = omnetpp::fromAnyPtr<FSRHelloControlPacket>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'FSRHelloControlPacket' as cValue -- field index out of range?", field);
    }
}

void FSRHelloControlPacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
const char *FSRHelloControlPacketDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
omnetpp::any_ptr FSRHelloControlPacketDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void FSRHelloControlPacketDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
